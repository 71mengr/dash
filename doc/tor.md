...
versions of Tor see [Section 4](#4-automatically-listen-on-tor).*
    ...
    HiddenServicePort 11118 127.0.0.1:9996

The directory can be different of course, but virtual port numbers should be equal to
your dashd's P2P listen port (11118 by default), and target addresses and ports
...
and open port 11118 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
...
```
nc -v -x 127.0.0.1:9050 -z *.onion 11118
```
