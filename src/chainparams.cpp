...
{
    const char* pszTimestamp = "US warns Americans worldwide to show increased caution as Iran war escalates - March 30 2026";
...
static CBlock CreateAndMaybeMineGenesisBlock(
    ...
    const uint256& expectedMerkleRoot)
{
    CBlock block = CreateGenesisBlock(nTime, nNonce, nBits, nVersion, genesisReward);
    const uint256 blockHash = block.GetHash();
    if (blockHash != expectedHash || block.hashMerkleRoot != expectedMerkleRoot) {
        LogPrintf(
            "CreateAndMaybeMineGenesisBlock(%s): hardcoded genesis mismatch (hash=%s merkle=%s), mining replacement\n",
            network_name, blockHash.ToString(), block.hashMerkleRoot.ToString());
        block.nNonce = 0;
        block = MineGenesisBlock(block);
    }
    return block;
}
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreasePeriod = 576; // 17280 - actual historical value
        consensus.nInstantSendConfirmationsRequired = 6;
        consensus.nInstantSendKeepLock = 24;
        consensus.nBudgetPaymentsStartBlock = 1600; // actual historical value
        ...
        consensus.BIP65Height = 619; // 00000000000076d8fcea02ec0963de4abfd01e771fec0863f960c2c64fe6f357
        consensus.BIP66Height = 630; // 00000000000b1fa2dfa312863570e13fae9ca7b5566cb27e55422620b469aefa
        consensus.BIP147Height = 939; // 00000000000000117befca4fab5622514772f608852e5edd8df9c55464b6fe37
        consensus.CSVHeight = 940; // 00000000000002e3d3a6224cfce80bae367fd3283d1e5a8ba50e5e60b2d2905d
        consensus.DIP0001Height = 782; // 000000000000000cbc9cb551e8ee1ac7aa223585cbdfb755d3683bafd93679e4
        consensus.DIP0003Height = 800;
        consensus.DIP0003EnforcementHeight = 820;
        consensus.DIP0003EnforcementHash = uint256S("");
        consensus.DIP0008Height = 830; // 00000000000000112e41e4b3afda8b233b8cc07c532d2eac5de097b68358c43e
        consensus.BRRHeight = 840; // 000000000000000c5a124f3eccfbe6e17876dca79cec9e63dfa70d269113c926
        consensus.DIP0020Height = 850; // 000000000000000f64ed3bd9af1078177ac026f6aa2677aa4d8beeae43be56cc
        consensus.DIP0024Height = 860; // 0000000000000001342be9c0b75ad40c276beaad91616423c4d9cb101b3db438
        consensus.DIP0024QuorumsHeight = 870; // 000000000000001aa25181e4c466e593992c98f9eb21c69ee757b8bb0af50244
        consensus.V19Height = 880; // 0000000000000015e32e73052d663626327004c81c5c22cb8b42c361015c0eae
        consensus.V20Height = 890; // 000000000000001bf41cff06b76780050682ca29e61a91c391893d4745579777
        consensus.MN_RRHeight = 910; // 0000000000000009a9696da93d3807eb14eb00a4ff449206d689156a21b27f26
        consensus.WithdrawalsHeight = 920; // 00000000000000210518749e17c00b035a2a4982c906236c28c41ea2231bf7ef
        consensus.MinBIP9WarningHeight = 920 + 2016; // withdrawals activation height + miner confirmation window
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.fProofOfStakeEnabled = true;
        consensus.nProofOfStakeHeight = 2600000;
        consensus.nStakeMinConfirmations = 100;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_V24].nStartTime = 1743292800; // July 1, 2025
        ...
        genesis = CreateAndMaybeMineGenesisBlock(
            "main",
            1743292800,
            28917698,
            0x1e0ffff0,
            1,
            50 * COIN,
            uint256S("0x00000ffd590b1485b3caadc19b22e6379c733355108f107a430458cdf3407ab6"),
            uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.fProofOfStakeEnabled = true;
        consensus.nProofOfStakeHeight = 1500;
        consensus.nStakeMinConfirmations = 100;
        consensus.nStakeTimestampMask = 0xf;
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Dash: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Dash: 2.5 minutes
        ...
        genesis = CreateAndMaybeMineGenesisBlock(
            ...
            1,
            50 * COIN,
            uint256S("0x00000bafbc94add76cb75e2ec92894837288a481e5c005f6563d91623bf8bc2c"),
            uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.DIP0008Height = 1; // DIP0008 activated immediately on devnet
        consensus.BRRHeight = 1;     // BRR (realloc) activated immediately on devnet
        consensus.DIP0020Height = 1; // DIP0020 activated immediately on devnet
        consensus.DIP0024Height = 1; // DIP0024 activated immediately on devnet
        consensus.DIP0024QuorumsHeight = 1; // DIP0024 activated immediately on devnet
        consensus.V19Height = 1;     // V19 activated immediately on devnet
        consensus.V20Height = 1;     // V20 activated immediately on devnet
        consensus.MN_RRHeight = 1;   // MN_RR activated immediately on devnet
        consensus.WithdrawalsHeight = 1;   // withdrawals activated immediately on devnet
        consensus.MinBIP9WarningHeight = 1 + 2016; // withdrawals activation height + miner confirmation window
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.fProofOfStakeEnabled = true;
        consensus.nProofOfStakeHeight = 500;
        consensus.nStakeMinConfirmations = 20;
        consensus.nStakeTimestampMask = 0xf;
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Dash: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Dash: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        genesis = CreateAndMaybeMineGenesisBlock(
            ...
            1,
            50 * COIN,
            uint256S("0x000008ca1832a4baf228eb1553c03d3a2c8e02399550dd6ea8d65cec3ef23d2e"),
            uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.fProofOfStakeEnabled = true;
        consensus.nProofOfStakeHeight = 250;
        consensus.nStakeMinConfirmations = 20;
        consensus.nStakeTimestampMask = 0xf;
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Dash: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Dash: 2.5 minutes
...
static void MaybeUpdateHeights(const ArgsManager& args, Consensus::Params& consensus)
{
    for (const std::string& arg : args.GetArgs("-testactivationheight")) {
        ...
        if (name == "bip147") {
            ...
            consensus.fProofOfStakeEnabled = true;
            consensus.nProofOfStakeHeight = int{height};
        } else {
...
void SetupChainParamsOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-testactivationheight=name@height.", "Set the activation height of 'name' (bip147, bip34, dersig, cltv, csv, brr, dip0001, dip0008, dip0024, v19, v20, mn_rr, pos). (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
